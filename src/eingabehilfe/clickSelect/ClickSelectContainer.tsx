    ...
    <div className="message is-info">
      <div className="message-header">
        {clickSelectData.rootCategories.length ? (
          <p>
            Kreisauswahl - durch Klicken auf Kuchenstücke
            Auswahl{" "}
      ...
      <div className="message-body">
        {clickSelectData.rootCategories.length ? (
          clickSelectData.rootCategories.map((cat) => {
            ...
            return catData ? (
              <ClickSelectCategory
                ...
                searchExpression={appState.searchexpression}
                categoryData={catData}
              />
            ) : (
              <div className="notification is-danger">
                Interner Fehler: no data for category {cat}
              </div>
            );
          })
        ) : (
          <div>
            <p>
              Keine weitere Einschränkung durch Kreisauswahl
              möglich, weil die Suche "
              {appState.searchexpression}" kein Kuchenbuffet
              übrig lässt.
            </p>{" "}
          </div>
        )}
