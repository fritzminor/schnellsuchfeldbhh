...
Die Suchauswahl kann auch weitergegeben werden (Smartphone-Deutsch: Teilen).

Dazu kann man einen Link mit der aktuellen Suchauswahl kopieren oder
...
Statt die Testdaten zu nutzen, kann man auch eigene Daten hochladen. Z.B. kann man die Daten, die der Freistaat Sachsen als Excel-Daten auf https://www.finanzen.sachsen.de/entwurf-doppelhaushalt-2021-2022-6436.html zur Verfügung stellt (ganz unten auf der Seite bei "maschinenlesbare Daten"), in den Prototyp importieren. Die Daten bleiben rein lokal im Browser. Die Daten werden auf keinen Server hochgeladen. 

Um die Daten hochzuladen, klickt man rechts oben auf das Bearbeiter-Menü, wo _BearbeiterEpl01und02_ steht. 
Im aufgehenden Dropdown-Menü wählt man _Excel-Import_. Dann wird man gebeten, die entsprechende Excel-Datei 
auszuwählen. Diese sollte man zuvor z.B. 
von https://www.finanzen.sachsen.de/entwurf-doppelhaushalt-2021-2022-6436.html[sachsen.de] heruntergeladen haben.

Man kann auch andere Daten hochladen, wenn sie im selben Format vorliegen. Bei anderen Formaten hilft evtl. ein <<Entwicklung,Issue>> auf https://github.com/fritzminor/schnellsuchfeldbhh/issues[github] einzustellen.
