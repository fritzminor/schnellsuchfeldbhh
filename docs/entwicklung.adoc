...
Der eigentliche Quellcode des Projekts findet sich im Ordner link:src/.

==== Unterordner nach Funktionalitäten

Abgesehen von zentralen Dateien wie link:src/App.tsx und link:src/index.tsx, die direkt im Ordner
...
Ein paar allgemeine Sätze zum Projekt finden sich in der README.adoc.
