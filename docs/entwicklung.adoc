...
Der eigentliche Quellcode des Projekts findet sich im Ordner xref:src/[].
...
Ein recht konsequentes Beispiel für diese Struktur findet sich in xref:src/eingabehilfe/searchfields/[] . 
